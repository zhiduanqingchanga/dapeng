...
/**
 * Created by cxq123456 on 2018/5/6. 添加okhttp类
 */
public class OkHttp {
    /**
     * 静态实例
    ...
    public static void postAsync1(String url, String json, DataCallBack callBack) {
        getInstance().inner_postAsync1(url, json, callBack);

    }
    /**
     dapeng  qingqiu    post
     * */
    private void inner_postAsync1(String url, String json, final DataCallBack callBack) {
